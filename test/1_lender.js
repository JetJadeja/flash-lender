...
contract("Lender", (accounts) => {
  ...
  it("Allows the owner to set the fee", async () => {
    /**
  ...
  it("Reverts if the setter isn't an owner", async () => {
    /**
  ...
  it("Reverts if the borrowed amount is too great", async () => {
    /**
  ...
  it("Reverts if the borrowed amount is not sufficient", async () => {
    /**
  ...
  it("Allows small loans if the fee is 0", async () => {
    /**
